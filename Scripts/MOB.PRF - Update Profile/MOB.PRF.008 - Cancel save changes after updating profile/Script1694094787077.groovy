...
Mobile.setText(findTestObject('profilePage/updateProfilePage/form_editPhone'), '12345678', 0)

Mobile.verifyElementExist(findTestObject('profilePage/updateProfilePage/txt_PhoneError'), 0)
